...
const TableCountries = ({flag, name, population, area, region}) => {
  ...
  return (
      <tr className="text-white items-center">
          <td className="py-3"><Image src={flag} width={100} height={100} alt={`${name} flag`} className="w-14 h-10 object-cover aspect-video rounded-md"/></td>
